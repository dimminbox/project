...
<header>
    ...
    <div class="slider-wrapper">
        <div class="slider">
            <ul class="items">
                <li>
                    <img src="<?php echo Yii::app()->request->baseUrl; ?>/public/images/slider-img1.gif" alt="">
                    <div class="banner">
                ...
                <li>
                    <img src="<?php echo Yii::app()->request->baseUrl; ?>/public/images/slider-img2.jpg" alt="">
                    <div class="banner">
                ...
                <li>
                    <img src="<?php echo Yii::app()->request->baseUrl; ?>/public/images/slider-img3.jpg" alt="">
                    <div class="banner">
