...
var $track=newTracker().mousedown(createDragger('move')).attr('id','jcrop-tracker-element').css({cursor:'move',position:'absolute',zIndex:360});if(Touch.support){$track.bind('touchstart.jcrop',Touch.createDragger('move')).bind('touchmove',Tracker.trackTouchMove).bind('touchend',Tracker.trackTouchEnd);}
